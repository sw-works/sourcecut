CREATE OR REPLACE VIEW odyssey_theme_passages_v AS
SELECT t.theme_id AS theme_id, t.title, t.description, t.aliases, t.bibliography, t.curator,
       p.theme_passage_id, p.rationale, p.evidence_class, p.text_unit_id AS text_unit_id,
