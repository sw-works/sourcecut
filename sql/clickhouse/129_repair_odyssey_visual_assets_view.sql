CREATE OR REPLACE VIEW odyssey_visual_assets_v AS
SELECT a.asset_id AS asset_id, a.provider, a.provider_id, a.title, a.description, a.creators,
       ...
       r.relationship_class AS relationship_class, r.production_use, r.limitations, r.evidence_ids,
