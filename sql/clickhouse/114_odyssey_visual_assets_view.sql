...
FROM media_assets FINAL AS a
INNER JOIN odyssey_asset_metadata FINAL AS m ON m.asset_id = a.asset_id
INNER JOIN asset_relationship_assessments FINAL AS r ON r.asset_id = a.asset_id
LEFT JOIN asset_corpus_links FINAL AS l ON l.asset_id = a.asset_id
