...
SELECT e.entity_id AS entity_id, e.entity_type, e.canonical_name, e.greek_name, e.aliases,
       e.description, e.authority_uris, e.curation_citations,
       m.mention_id, m.text_unit_id AS text_unit_id, m.version_id, m.book, m.line_start, m.line_end,
